...
def upload_image():
    ...
    if uploaded_file is not None:
        ...
        # Access other metadata like the filename
...
# Get the contents and filename of the uploaded image
image_contents, image_filename = upload_image()

# Now you can work with image_contents and image_filename as needed
